...
type NameServer struct {
	...
	QueryStrategy   QueryStrategy          `protobuf:"varint,7,opt,name=query_strategy,json=queryStrategy,proto3,enum=bypasscore.app.dns.QueryStrategy" json:"query_strategy,omitempty"`
...
type Config struct {
	...
	QueryStrategy          QueryStrategy `protobuf:"varint,9,opt,name=query_strategy,json=queryStrategy,proto3,enum=bypasscore.app.dns.QueryStrategy" json:"query_strategy,omitempty"`
...
const file_app_dns_config_proto_rawDesc = "" +
	...
	"\fskipFallback\x18\x06 \x01(\bR\fskipFallback\x12=\n" +
	"\x06domain\x18\x02 \x03(\v2%.bypasscore.common.geodata.DomainRuleR\x06domain\x12B\n" +
	"\vexpected_ip\x18\x03 \x03(\v2!.bypasscore.common.geodata.IPRuleR\n" +
	"expectedIp\x12H\n" +
	"\x0equery_strategy\x18\a \x01(\x0e2!.bypasscore.app.dns.QueryStrategyR\rqueryStrategy\x12\x1a\n" +
	...
	"finalQuery\x12F\n" +
	"\runexpected_ip\x18\r \x03(\v2!.bypasscore.common.geodata.IPRuleR\funexpectedIp\x12\x1e\n" +
	"\n" +
	...
	"\x06Config\x12?\n" +
	"\vname_server\x18\x05 \x03(\v2\x1e.bypasscore.app.dns.NameServerR\n" +
	"nameServer\x12\x1b\n" +
	"\tclient_ip\x18\x03 \x01(\fR\bclientIp\x12I\n" +
	"\fstatic_hosts\x18\x04 \x03(\v2&.bypasscore.app.dns.Config.HostMappingR\vstaticHosts\x12\x10\n" +
	"\x03tag\x18\x06 \x01(\tR\x03tag\x12\"\n" +
	"\fdisableCache\x18\b \x01(\bR\fdisableCache\x12\x1e\n" +
	"\n" +
	"serveStale\x18\f \x01(\bR\n" +
	"serveStale\x12(\n" +
	"\x0fserveExpiredTTL\x18\r \x01(\rR\x0fserveExpiredTTL\x12H\n" +
	"\x0equery_strategy\x18\t \x01(\x0e2!.bypasscore.app.dns.QueryStrategyR\rqueryStrategy\x12(\n" +
	...
	"\x13enableParallelQuery\x18\x0e \x01(\bR\x13enableParallelQuery\x1a\x83\x01\n" +
	"\vHostMapping\x12=\n" +
	"\x06domain\x18\x02 \x01(\v2%.bypasscore.common.geodata.DomainRuleR\x06domain\x12\x0e\n" +
	...
	"\aUSE_SYS\x10\x03BU\n" +
	"\x16com.bypasscore.app.dnsP\x01Z$github.com/eugene/bypasscore/app/dns\xaa\x02\x12Bypasscore.App.Dnsb\x06proto3"
...
var file_app_dns_config_proto_goTypes = []any{
	(QueryStrategy)(0),         // 0: bypasscore.app.dns.QueryStrategy
	(*NameServer)(nil),         // 1: bypasscore.app.dns.NameServer
	(*Config)(nil),             // 2: bypasscore.app.dns.Config
	(*Config_HostMapping)(nil), // 3: bypasscore.app.dns.Config.HostMapping
	(*net.Endpoint)(nil),       // 4: bypasscore.common.net.Endpoint
	(*geodata.DomainRule)(nil), // 5: bypasscore.common.geodata.DomainRule
	(*geodata.IPRule)(nil),     // 6: bypasscore.common.geodata.IPRule
}
var file_app_dns_config_proto_depIdxs = []int32{
	4, // 0: bypasscore.app.dns.NameServer.address:type_name -> bypasscore.common.net.Endpoint
	5, // 1: bypasscore.app.dns.NameServer.domain:type_name -> bypasscore.common.geodata.DomainRule
	6, // 2: bypasscore.app.dns.NameServer.expected_ip:type_name -> bypasscore.common.geodata.IPRule
	0, // 3: bypasscore.app.dns.NameServer.query_strategy:type_name -> bypasscore.app.dns.QueryStrategy
	6, // 4: bypasscore.app.dns.NameServer.unexpected_ip:type_name -> bypasscore.common.geodata.IPRule
	1, // 5: bypasscore.app.dns.Config.name_server:type_name -> bypasscore.app.dns.NameServer
	3, // 6: bypasscore.app.dns.Config.static_hosts:type_name -> bypasscore.app.dns.Config.HostMapping
	0, // 7: bypasscore.app.dns.Config.query_strategy:type_name -> bypasscore.app.dns.QueryStrategy
	5, // 8: bypasscore.app.dns.Config.HostMapping.domain:type_name -> bypasscore.common.geodata.DomainRule
