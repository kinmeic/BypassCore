...
const file_app_observatory_config_proto_rawDesc = "" +
	"\n" +
	"\x1capp/observatory/config.proto\x12\x1abypasscore.app.observatory\"W\n" +
	"\x11ObservationResult\x12B\n" +
	"\x06status\x18\x01 \x03(\v2*.bypasscore.app.observatory.OutboundStatusR\x06status\"\x9f\x01\n" +
	...
	"\vhealth_ping\x18\a \x01(\v27.bypasscore.app.observatory.HealthPingMeasurementResultR\n" +
	"healthPing\"e\n" +
	...
	"\x1ecom.bypasscore.app.observatoryP\x01Z,github.com/eugene/bypasscore/app/observatory\xaa\x02\x1aBypasscore.App.Observatoryb\x06proto3"
...
var file_app_observatory_config_proto_goTypes = []any{
	(*ObservationResult)(nil),           // 0: bypasscore.app.observatory.ObservationResult
	(*HealthPingMeasurementResult)(nil), // 1: bypasscore.app.observatory.HealthPingMeasurementResult
	(*OutboundStatus)(nil),              // 2: bypasscore.app.observatory.OutboundStatus
	(*ProbeResult)(nil),                 // 3: bypasscore.app.observatory.ProbeResult
	(*Intensity)(nil),                   // 4: bypasscore.app.observatory.Intensity
	(*Config)(nil),                      // 5: bypasscore.app.observatory.Config
}
var file_app_observatory_config_proto_depIdxs = []int32{
	2, // 0: bypasscore.app.observatory.ObservationResult.status:type_name -> bypasscore.app.observatory.OutboundStatus
	1, // 1: bypasscore.app.observatory.OutboundStatus.health_ping:type_name -> bypasscore.app.observatory.HealthPingMeasurementResult
