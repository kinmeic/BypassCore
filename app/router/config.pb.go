...
import (
	geodata "github.com/eugene/bypasscore/common/geodata"
	net "github.com/eugene/bypasscore/common/net"
	serial "github.com/eugene/bypasscore/common/serial"
...
type RoutingRule struct {
	...
	Networks []net.Network `protobuf:"varint,13,rep,packed,name=networks,proto3,enum=bypasscore.common.net.Network" json:"networks,omitempty"`
...
const file_app_router_config_proto_rawDesc = "" +
	"\n" +
	"\x17app/router/config.proto\x12\x15bypasscore.app.router\x1a!common/serial/typed_message.proto\x1a\x15common/net/port.proto\x1a\x18common/net/network.proto\x1a\x1bcommon/geodata/geodat.proto\"\x83\b\n" +
	...
	"\x06domain\x18\x02 \x03(\v2%.bypasscore.common.geodata.DomainRuleR\x06domain\x121\n" +
	"\x02ip\x18\n" +
	" \x03(\v2!.bypasscore.common.geodata.IPRuleR\x02ip\x12<\n" +
	"\tport_list\x18\x0e \x01(\v2\x1f.bypasscore.common.net.PortListR\bportList\x12:\n" +
	"\bnetworks\x18\r \x03(\x0e2\x1e.bypasscore.common.net.NetworkR\bnetworks\x12>\n" +
	"\tsource_ip\x18\v \x03(\v2!.bypasscore.common.geodata.IPRuleR\bsourceIp\x12I\n" +
	"\x10source_port_list\x18\x10 \x01(\v2\x1f.bypasscore.common.net.PortListR\x0esourcePortList\x12\x1d\n" +
	"\n" +
	"user_email\x18\a \x03(\tR\tuserEmail\x12\x1f\n" +
	"\vinbound_tag\x18\b \x03(\tR\n" +
	"inboundTag\x12\x1a\n" +
	"\bprotocol\x18\t \x03(\tR\bprotocol\x12R\n" +
	"\n" +
	"attributes\x18\x0f \x03(\v22.bypasscore.app.router.RoutingRule.AttributesEntryR\n" +
	"attributes\x12<\n" +
	"\blocal_ip\x18\x11 \x03(\v2!.bypasscore.common.geodata.IPRuleR\alocalIp\x12G\n" +
	"\x0flocal_port_list\x18\x12 \x01(\v2\x1f.bypasscore.common.net.PortListR\rlocalPortList\x12I\n" +
	"\x10vless_route_list\x18\x14 \x01(\v2\x1f.bypasscore.common.net.PortListR\x0evlessRouteList\x12\x18\n" +
	"\aprocess\x18\x15 \x03(\tR\aprocess\x12>\n" +
	"\awebhook\x18\x16 \x01(\v2$.bypasscore.app.router.WebhookConfigR\awebhook\x1a=\n" +
	...
	"\rdeduplication\x18\x02 \x01(\rR\rdeduplication\x12K\n" +
	"\aheaders\x18\x03 \x03(\v21.bypasscore.app.router.WebhookConfig.HeadersEntryR\aheaders\x1a:\n" +
	...
	"\x11strategy_settings\x18\x04 \x01(\v2&.bypasscore.common.serial.TypedMessageR\x10strategySettings\x12!\n" +
	...
	"\x05value\x18\x03 \x01(\x02R\x05value\"\xc6\x01\n" +
	"\x17StrategyLeastLoadConfig\x12;\n" +
	"\x05costs\x18\x02 \x03(\v2%.bypasscore.app.router.StrategyWeightR\x05costs\x12\x1c\n" +
	...
	"\n" +
	"IpOnDemand\x10\x03\"\x04\b\x01\x10\x01B^\n" +
	"\x19com.bypasscore.app.routerP\x01Z'github.com/eugene/bypasscore/app/router\xaa\x02\x15Bypasscore.App.Routerb\x06proto3"
...
var file_app_router_config_proto_goTypes = []any{
	(Config_DomainStrategy)(0),      // 0: bypasscore.app.router.Config.DomainStrategy
	(*RoutingRule)(nil),             // 1: bypasscore.app.router.RoutingRule
	(*WebhookConfig)(nil),           // 2: bypasscore.app.router.WebhookConfig
	(*BalancingRule)(nil),           // 3: bypasscore.app.router.BalancingRule
	(*StrategyWeight)(nil),          // 4: bypasscore.app.router.StrategyWeight
	(*StrategyLeastLoadConfig)(nil), // 5: bypasscore.app.router.StrategyLeastLoadConfig
	(*Config)(nil),                  // 6: bypasscore.app.router.Config
	nil,                             // 7: bypasscore.app.router.RoutingRule.AttributesEntry
	nil,                             // 8: bypasscore.app.router.WebhookConfig.HeadersEntry
	(*geodata.DomainRule)(nil),      // 9: bypasscore.common.geodata.DomainRule
	(*geodata.IPRule)(nil),          // 10: bypasscore.common.geodata.IPRule
	(*net.PortList)(nil),            // 11: bypasscore.common.net.PortList
	(net.Network)(0),                // 12: bypasscore.common.net.Network
	(*serial.TypedMessage)(nil),     // 13: bypasscore.common.serial.TypedMessage
}
var file_app_router_config_proto_depIdxs = []int32{
	9,  // 0: bypasscore.app.router.RoutingRule.domain:type_name -> bypasscore.common.geodata.DomainRule
	10, // 1: bypasscore.app.router.RoutingRule.ip:type_name -> bypasscore.common.geodata.IPRule
	11, // 2: bypasscore.app.router.RoutingRule.port_list:type_name -> bypasscore.common.net.PortList
	12, // 3: bypasscore.app.router.RoutingRule.networks:type_name -> bypasscore.common.net.Network
	10, // 4: bypasscore.app.router.RoutingRule.source_ip:type_name -> bypasscore.common.geodata.IPRule
	11, // 5: bypasscore.app.router.RoutingRule.source_port_list:type_name -> bypasscore.common.net.PortList
	7,  // 6: bypasscore.app.router.RoutingRule.attributes:type_name -> bypasscore.app.router.RoutingRule.AttributesEntry
	10, // 7: bypasscore.app.router.RoutingRule.local_ip:type_name -> bypasscore.common.geodata.IPRule
	11, // 8: bypasscore.app.router.RoutingRule.local_port_list:type_name -> bypasscore.common.net.PortList
	11, // 9: bypasscore.app.router.RoutingRule.vless_route_list:type_name -> bypasscore.common.net.PortList
	2,  // 10: bypasscore.app.router.RoutingRule.webhook:type_name -> bypasscore.app.router.WebhookConfig
	8,  // 11: bypasscore.app.router.WebhookConfig.headers:type_name -> bypasscore.app.router.WebhookConfig.HeadersEntry
	13, // 12: bypasscore.app.router.BalancingRule.strategy_settings:type_name -> bypasscore.common.serial.TypedMessage
	4,  // 13: bypasscore.app.router.StrategyLeastLoadConfig.costs:type_name -> bypasscore.app.router.StrategyWeight
	0,  // 14: bypasscore.app.router.Config.domain_strategy:type_name -> bypasscore.app.router.Config.DomainStrategy
	1,  // 15: bypasscore.app.router.Config.rule:type_name -> bypasscore.app.router.RoutingRule
	3,  // 16: bypasscore.app.router.Config.balancing_rule:type_name -> bypasscore.app.router.BalancingRule
