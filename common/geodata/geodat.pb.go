...
type Domain struct {
	...
	Type Domain_Type `protobuf:"varint,1,opt,name=type,proto3,enum=bypasscore.common.geodata.Domain_Type" json:"type,omitempty"`
	// Domain value.
...
const file_common_geodata_geodat_proto_rawDesc = "" +
	"\n" +
	"\x1bcommon/geodata/geodat.proto\x12\x19bypasscore.common.geodata\"\xc8\x02\n" +
	"\x06Domain\x12:\n" +
	"\x04type\x18\x01 \x01(\x0e2&.bypasscore.common.geodata.Domain.TypeR\x04type\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12I\n" +
	"\tattribute\x18\x03 \x03(\v2+.bypasscore.common.geodata.Domain.AttributeR\tattribute\x1al\n" +
	"\tAttribute\x12\x10\n" +
	...
	"\x06domain\x18\x02 \x03(\v2!.bypasscore.common.geodata.DomainR\x06domain\"G\n" +
	"\vGeoSiteList\x128\n" +
	"\x05entry\x18\x01 \x03(\v2\".bypasscore.common.geodata.GeoSiteR\x05entry\"K\n" +
	"\vGeoSiteRule\x12\x12\n" +
	"\x04file\x18\x01 \x01(\tR\x04file\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x14\n" +
	"\x05attrs\x18\x03 \x01(\tR\x05attrs\"\x96\x01\n" +
	"\n" +
	"DomainRule\x12B\n" +
	"\ageosite\x18\x01 \x01(\v2&.bypasscore.common.geodata.GeoSiteRuleH\x00R\ageosite\x12;\n" +
	"\x06custom\x18\x02 \x01(\v2!.bypasscore.common.geodata.DomainH\x00R\x06customB\a\n" +
	"\x05value\".\n" +
	"\x04CIDR\x12\x0e\n" +
	"\x02ip\x18\x01 \x01(\fR\x02ip\x12\x16\n" +
	"\x06prefix\x18\x02 \x01(\rR\x06prefix\"d\n" +
	"\bCIDRRule\x123\n" +
	"\x04cidr\x18\x01 \x01(\v2\x1f.bypasscore.common.geodata.CIDRR\x04cidr\x12#\n" +
	"\rreverse_match\x18\x02 \x01(\bR\freverseMatch\"u\n" +
	"\x05GeoIP\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x123\n" +
	"\x04cidr\x18\x02 \x03(\v2\x1f.bypasscore.common.geodata.CIDRR\x04cidr\x12#\n" +
	"\rreverse_match\x18\x03 \x01(\bR\freverseMatch\"C\n" +
	"\tGeoIPList\x126\n" +
	"\x05entry\x18\x01 \x03(\v2 .bypasscore.common.geodata.GeoIPR\x05entry\"X\n" +
	"\tGeoIPRule\x12\x12\n" +
	"\x04file\x18\x01 \x01(\tR\x04file\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12#\n" +
	"\rreverse_match\x18\x03 \x01(\bR\freverseMatch\"\x8e\x01\n" +
	"\x06IPRule\x12<\n" +
	"\x05geoip\x18\x01 \x01(\v2$.bypasscore.common.geodata.GeoIPRuleH\x00R\x05geoip\x12=\n" +
	"\x06custom\x18\x02 \x01(\v2#.bypasscore.common.geodata.CIDRRuleH\x00R\x06customB\a\n" +
	"\x05valueBj\n" +
	"\x1dcom.bypasscore.common.geodataP\x01Z+github.com/eugene/bypasscore/common/geodata\xaa\x02\x19Bypasscore.Common.Geodatab\x06proto3"
...
var file_common_geodata_geodat_proto_goTypes = []any{
	(Domain_Type)(0),         // 0: bypasscore.common.geodata.Domain.Type
	(*Domain)(nil),           // 1: bypasscore.common.geodata.Domain
	(*GeoSite)(nil),          // 2: bypasscore.common.geodata.GeoSite
	(*GeoSiteList)(nil),      // 3: bypasscore.common.geodata.GeoSiteList
	(*GeoSiteRule)(nil),      // 4: bypasscore.common.geodata.GeoSiteRule
	(*DomainRule)(nil),       // 5: bypasscore.common.geodata.DomainRule
	(*CIDR)(nil),             // 6: bypasscore.common.geodata.CIDR
	(*CIDRRule)(nil),         // 7: bypasscore.common.geodata.CIDRRule
	(*GeoIP)(nil),            // 8: bypasscore.common.geodata.GeoIP
	(*GeoIPList)(nil),        // 9: bypasscore.common.geodata.GeoIPList
	(*GeoIPRule)(nil),        // 10: bypasscore.common.geodata.GeoIPRule
	(*IPRule)(nil),           // 11: bypasscore.common.geodata.IPRule
	(*Domain_Attribute)(nil), // 12: bypasscore.common.geodata.Domain.Attribute
}
var file_common_geodata_geodat_proto_depIdxs = []int32{
	0,  // 0: bypasscore.common.geodata.Domain.type:type_name -> bypasscore.common.geodata.Domain.Type
	12, // 1: bypasscore.common.geodata.Domain.attribute:type_name -> bypasscore.common.geodata.Domain.Attribute
	1,  // 2: bypasscore.common.geodata.GeoSite.domain:type_name -> bypasscore.common.geodata.Domain
	2,  // 3: bypasscore.common.geodata.GeoSiteList.entry:type_name -> bypasscore.common.geodata.GeoSite
	4,  // 4: bypasscore.common.geodata.DomainRule.geosite:type_name -> bypasscore.common.geodata.GeoSiteRule
	1,  // 5: bypasscore.common.geodata.DomainRule.custom:type_name -> bypasscore.common.geodata.Domain
	6,  // 6: bypasscore.common.geodata.CIDRRule.cidr:type_name -> bypasscore.common.geodata.CIDR
	6,  // 7: bypasscore.common.geodata.GeoIP.cidr:type_name -> bypasscore.common.geodata.CIDR
	8,  // 8: bypasscore.common.geodata.GeoIPList.entry:type_name -> bypasscore.common.geodata.GeoIP
	10, // 9: bypasscore.common.geodata.IPRule.geoip:type_name -> bypasscore.common.geodata.GeoIPRule
	7,  // 10: bypasscore.common.geodata.IPRule.custom:type_name -> bypasscore.common.geodata.CIDRRule
