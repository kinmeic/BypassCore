...
const file_common_net_port_proto_rawDesc = "" +
	"\n" +
	"\x15common/net/port.proto\x12\x15bypasscore.common.net\"/\n" +
	"\tPortRange\x12\x12\n" +
	"\x04From\x18\x01 \x01(\rR\x04From\x12\x0e\n" +
	"\x02To\x18\x02 \x01(\rR\x02To\"B\n" +
	"\bPortList\x126\n" +
	"\x05range\x18\x01 \x03(\v2 .bypasscore.common.net.PortRangeR\x05rangeB^\n" +
...
var file_common_net_port_proto_goTypes = []any{
	(*PortRange)(nil), // 0: bypasscore.common.net.PortRange
	(*PortList)(nil),  // 1: bypasscore.common.net.PortList
}
var file_common_net_port_proto_depIdxs = []int32{
	0, // 0: bypasscore.common.net.PortList.range:type_name -> bypasscore.common.net.PortRange
