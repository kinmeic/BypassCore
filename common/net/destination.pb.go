...
type Endpoint struct {
	...
	Network       Network                `protobuf:"varint,1,opt,name=network,proto3,enum=bypasscore.common.net.Network" json:"network,omitempty"`
...
const file_common_net_destination_proto_rawDesc = "" +
	"\n" +
	"\x1ccommon/net/destination.proto\x12\x15bypasscore.common.net\x1a\x18common/net/network.proto\x1a\x18common/net/address.proto\"\x95\x01\n" +
	"\bEndpoint\x128\n" +
	"\anetwork\x18\x01 \x01(\x0e2\x1e.bypasscore.common.net.NetworkR\anetwork\x12;\n" +
	"\aaddress\x18\x02 \x01(\v2!.bypasscore.common.net.IPOrDomainR\aaddress\x12\x12\n" +
	"\x04port\x18\x03 \x01(\rR\x04portB^\n" +
	"\x19com.bypasscore.common.netP\x01Z'github.com/eugene/bypasscore/common/net\xaa\x02\x15Bypasscore.Common.Netb\x06proto3"
...
var file_common_net_destination_proto_goTypes = []any{
	(*Endpoint)(nil),   // 0: bypasscore.common.net.Endpoint
	(Network)(0),       // 1: bypasscore.common.net.Network
	(*IPOrDomain)(nil), // 2: bypasscore.common.net.IPOrDomain
}
var file_common_net_destination_proto_depIdxs = []int32{
	1, // 0: bypasscore.common.net.Endpoint.network:type_name -> bypasscore.common.net.Network
	2, // 1: bypasscore.common.net.Endpoint.address:type_name -> bypasscore.common.net.IPOrDomain
