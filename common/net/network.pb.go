...
type NetworkList struct {
	...
	Network       []Network              `protobuf:"varint,1,rep,packed,name=network,proto3,enum=bypasscore.common.net.Network" json:"network,omitempty"`
...
const file_common_net_network_proto_rawDesc = "" +
	"\n" +
	"\x18common/net/network.proto\x12\x15bypasscore.common.net\"G\n" +
	"\vNetworkList\x128\n" +
	"\anetwork\x18\x01 \x03(\x0e2\x1e.bypasscore.common.net.NetworkR\anetwork*2\n" +
	"\aNetwork\x12\v\n" +
...
var file_common_net_network_proto_goTypes = []any{
	(Network)(0),        // 0: bypasscore.common.net.Network
	(*NetworkList)(nil), // 1: bypasscore.common.net.NetworkList
}
var file_common_net_network_proto_depIdxs = []int32{
	0, // 0: bypasscore.common.net.NetworkList.network:type_name -> bypasscore.common.net.Network
